...
function WEDecor() {
  ...
  function handleEventClick(event) {
    const clickedEventName = event.target.innerText.toLowerCase().replace(/\s+/g, ' '); // Replace multiple spaces with a single space
    ...
    <div>
      ...
      <div className="flex justify-between px-6 py-6 md:flex-col md:gap-y-4">
        <ul className="flex flex-col gap-y-3 md:flex-row md:justify-center md:gap-6 lg:gap-8 md:items-center">
          <li
            className={`${selectedEvent.eventName === "Birthday"? "font-bold text-[#372825]":null} text-gray-900 capitalize cursor-pointer transition duration-150 ease-in-out`}
            onClick={() =>
          ...
          <li className={`${selectedEvent.eventName === "Baby Shower"? "font-bold text-[#372825]":null} text-gray-900 capitalize cursor-pointer transition duration-150 ease-in-out`}
           onClick={() =>
          ...
          <li className={`${selectedEvent.eventName === "Haldi Ceremony"? "font-bold text-[#372825]":null} text-gray-900 capitalize cursor-pointer transition duration-150 ease-in-out`}
           onClick={() =>
          ...
          <li className={`${selectedEvent.eventName === "wedding ceremony"? "font-bold text-[#372825]":null} text-gray-900 capitalize cursor-pointer transition duration-150 ease-in-out`}
           onClick={() =>
          ...
          <li className={`${selectedEvent.eventName === "Mehendi ceremony"? "font-bold text-[#372825]":null} text-gray-900 capitalize cursor-pointer transition duration-150 ease-in-out`}
           onClick={() =>
        ...
        <ul className="flex flex-col gap-y-3 md:flex-row md:justify-center md:gap-6 lg:gap-8 md:items-center">
          <li className={`${selectedEvent.eventName === "Dholki Decor"? "font-bold text-[#372825]":null} text-gray-900 capitalize cursor-pointer transition duration-150 ease-in-out`}
           onClick={() =>
          ...
          <li className={`${selectedEvent.eventName === "Hall Decoration"? "font-bold text-[#372825]":null} text-gray-900 capitalize cursor-pointer transition duration-150 ease-in-out`}
           onClick={() =>
          ...
          <li className={`${selectedEvent.eventName === "Bride/Groom Shower"? "font-bold text-[#372825]":null} text-gray-900 capitalize cursor-pointer transition duration-150 ease-in-out`}
           onClick={() =>
          ...
          <li className={`${selectedEvent.eventName === "Arabic Nights"? "font-bold text-[#372825]":null} text-gray-900 capitalize cursor-pointer  transition duration-150 ease-in-out`}
           onClick={() =>
